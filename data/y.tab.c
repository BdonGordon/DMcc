...
{
  "$end", "error", "$undefined", "EQUALS", "LCURLY", "RCURLY", "COMMA",
  "SECTIONDELIM", "TITLE", "FIELD", "BUTTON", "WORD", "SEMI", "QUOTE",
  "$accept", "file", "top", "titleExp", "fieldExp", "buttonExp", "string",
  "list", "bottom", YY_NULLPTR
};
#endif
...
{
      -6,     0,    15,    14,    11,    -2,   -21,    12,    19,    16,
       3,    -2,    17,    22,    20,    -3,    24,   -21,    -2,   -21,
     -21,   -21,    -2,    25,    -3,    13,    18,    -3,    21,    -2,
     -21,   -21,    -3,   -21,    23,   -21,    26,   -21,   -21,   -21
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     0,     0,     0,     2,     0,     0,     3,     9,     8,
       7,     4,     0,     0,     0,     0,     0,     0,     0,     0,
      10,    12,     0,     5,     0,    14,     0,    11,     6,    13
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -21,   -21,   -21,   -21,   -21,   -21,    -5,   -20,   -21
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     4,     9,    17,    25,    26,    14
};
...
{
      12,    24,     1,     5,    30,    19,    20,    34,    10,    10,
      11,    11,    37,    20,    10,     6,    18,    28,    31,    32,
       8,     7,    15,    13,    36,    22,    16,    27,    29,    21,
      33,    23,     0,    35,     0,    38,     0,     0,    39
};

static const yytype_int8 yycheck[] =
{
       5,     4,     8,     3,    24,    10,    11,    27,    11,    11,
      13,    13,    32,    18,    11,     0,    13,    22,     5,     6,
       9,     7,     3,    11,    29,     3,    10,     3,     3,    12,
      12,    11,    -1,    12,    -1,    12,    -1,    -1,    12
};
...
{
       0,     8,    15,    16,    17,     3,     0,     7,     9,    18,
      11,    13,    20,    11,    22,     3,    10,    19,    13,    20,
      20,    12,     3,    11,     4,    20,    21,     3,    20,     3,
      21,     5,     6,    12,    21,    12,    20,    21,    12,    12
};
...
#line 26 "Yacc.y" /* yacc.c:1646  */
    { strcpy(bottomEles, (yyvsp[0].str_val)); printf("%s\n", bottomEles); }
...
#line 32 "Yacc.y" /* yacc.c:1646  */
    { strcpy(titleE, (yyvsp[-1].str_val)); printf("%s\n", titleE); }
#line 1267 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 35 "Yacc.y" /* yacc.c:1646  */
    { strcpy(fieldsE, (yyvsp[-1].str_val)); printf("%s:\n", fieldsE); }
#line 1273 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 38 "Yacc.y" /* yacc.c:1646  */
    { strcpy(buttonsE, (yyvsp[-1].str_val)); printf("%s:\n", buttonsE);}
...
#line 42 "Yacc.y" /* yacc.c:1646  */
    { strcat((yyvsp[-1].str_val), " "); strcat((yyvsp[-1].str_val), (yyvsp[0].str_val)); }
...
#line 47 "Yacc.y" /* yacc.c:1646  */
    { strcat((yyvsp[-2].str_val), ", "); strcat((yyvsp[-2].str_val), (yyvsp[0].str_val)); }
...
#line 51 "Yacc.y" /* yacc.c:1646  */
    { strcat((yyvsp[-3].str_val), "="); strcat((yyvsp[-3].str_val), (yyvsp[-1].str_val)); strcat((yyvsp[-3].str_val), "\n"); strcat((yyvsp[-4].str_val), (yyvsp[-3].str_val)); (yyval.str_val) = (yyvsp[-4].str_val); }
#line 1321 "y.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 52 "Yacc.y" /* yacc.c:1646  */
    { strcat((yyvsp[-3].str_val), "="); strcat((yyvsp[-3].str_val), (yyvsp[-1].str_val)); (yyval.str_val) = (yyvsp[-3].str_val); }
